				...
				<div class="container-fluid">
					...
					<div class=" row m-5">
						<div class="w-100 mb-5">
							<input type="button" class="btn btn-primary w-15" value="견주" onclick="location.href='<%=cp %>/userbyeownerlist.action'"/>
							<input type="button" class="btn btn-outline-primary w-15" value="워커" onclick="location.href='<%=cp %>/userbyeworkerlist.action'"/>
						</div>
						...
						<div class="table-responsive">
							<form action="<%=cp %>/userbyeownerdetail.action" method="post">
				                <table class="table">
