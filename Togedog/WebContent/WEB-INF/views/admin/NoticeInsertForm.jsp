						...
						<div class="col-lg-10 m-auto">
							...
							<div class="card">
								<div class="card-header">
									<h1 class="h3 mb-2 mt-2 text-gray-600">공지사항 작성</h1>
								</div>
								<form action="<%=cp %>/noticeinsert.action" method="post">
									<div class="card-body">
										<div class="row">
											<div class="col-sm-2">
										...
										<div class="row mt-3">
											<div class="col-md-12">
												<div class="form-group">
													...
													<div class="col-md-12">
														<textarea name="content" id="content" class="textarea form-control" rows="20"></textarea>
													</div>
												</div>
											</div>
										</div>
