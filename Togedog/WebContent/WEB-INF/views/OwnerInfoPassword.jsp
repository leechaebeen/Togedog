			...
			<div class="content-wrap col-md-12">
				...
				<div class="content col-md-11">
					...
					<div class="main col-md-12">
						...
						<div class="col-md-6" style="border: 1px solid #F2F2F2; margin: 50px 0px 50px 0px; padding: 100px 0px 100px 0px;">
							<div class="col-md-12">
								<p>※ 정보 수정 전 본인 확인을 위해 비밀번호를 눌러주세요.</p>
								<br /><br />
								<form class="form-inline">
								  ...
								  &nbsp;&nbsp;
								  <button type="submit" class="btn btn-sm btn-default">확인</button>
								</form>
							</div>
						</div>
						<div class="col-md-3"></div>
