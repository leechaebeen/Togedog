										...
										<td colspan="3">
											<div class="col-md-12">
												...
												<select class="form-control" onchange="">
													<option value="1">산책기록</option>
													<option value="2">미용기록</option>
													<option value="3">건강기록</option>
													<option value="4">교육기록</option>
													<option value="5">용품기록</option>
													<option value="6">기타기록</option>
												</select>
												-->
											</div>
										</td>
								...
								<table class="table">
									...
									<tr>
										...
										<td style="width: 50%"><input type="text"
											class="form-control" name="moneyContent" /></td>
										<td style="width: 25%"><input type="text"
											class="form-control" name="price" placeholder="금액"></td>
									</tr>
									<tr>
										<td style="width: 25%"><select class="form-control">
												<option>지출</option>
									...
									<tr>
										<td colspan="4">
											<button type="button" class="btn-warning btn-xs pull-right">
