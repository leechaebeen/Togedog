	...
	<div class="col-md-12" style="margin-top: 60px; margin-bottom: 100px;">
		<div class="col-md-6" style="text-align:center;">
			<div class="col-md-12">
				...
				onclick="location.href='<%=cp%>/addPetForm.action?ownCd=${ownCd }'">등록할래요</button>
			</div>
		...
		<div class="col-md-6" style="text-align:center;">
			<div class="col-md-12">
				...
				onclick="location.href='<%=cp%>/addOwnComp.action'">공유받아요</button>
			</div>
			<div class="col-md-12" style="margin-top: 10px;">
			<span style="font-size: 13px; font-weight: bold; color: #828282;">공유받기 전에는 서비스를 이용할 수 없어요. 빠른 시일 내에 공유받기를 권유합니다</span>
			</div>
		</div>
	</div>
</div>
